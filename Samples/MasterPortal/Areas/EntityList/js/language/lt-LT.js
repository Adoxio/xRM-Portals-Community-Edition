...
window.calendar_languages['lt-LT'] = {
	error_noview: 'Kalendorius: rodinys {0} nerastas',
	error_dateformat: 'Kalendorius: netinkamas datos formatas {0}. Formatas turi būti arba „dabar“, arba „MMMM-mm-dd“',
	error_loadurl: 'Kalendorius: nenustatytas įvykio URL',
	error_where: 'Kalendorius: neteisinga naršymo kryptis {0}. Gali būti tik „next“, „prev“ arba „today“',
	error_timedevide: 'Kalendorius: laiko padalijimo parametras turi padalyti 60 be dešimtainių dalių. Pavyzdžiui, 10, 15, 30',

	no_events_in_day: 'Šios dienos įvykių nėra.',
	...
	time:        'Laikas',
	events:      'Įvykiai',
	before_time: 'Baigiasi prieš laiko planavimo juostą',
	after_time:  'Prasideda po laiko planavimo juostos',
