...
window.calendar_languages['th-TH'] = {
	error_noview: 'ปฏิทิน: ไม่พบมุมมอง {0}',
	error_dateformat: 'ปฏิทิน: รูปแบบวันที่ไม่ถูกต้อง {0} ควรเป็น \"ตอนนี้\" หรือ \"ปปปป-ดด-วว\"',
	error_loadurl: 'ปฏิทิน: ไม่ได้ตั้งค่า URL เหตุการณ์',
	error_where: 'ปฏิทิน: ทิศทางการนำทางไม่ถูกต้อง {0} ต้องเป็น \"ถัดไป\" หรือ \"ก่อนหน้า\" หรือ \"วันนี้\"',
	error_timedevide: 'ปฏิทิน: พารามิเตอร์การแยกเวลาควรหาร 60 ด้วยค่าที่ไม่ใช่ทศนิยม อย่างเช่น 10, 15, 30',

	no_events_in_day: 'ไม่มีเหตุการณ์ในวันนี้',
	...
	time:        'เวลา',
	events:      'เหตุการณ์',
	before_time: 'สิ้นสุดก่อนเส้นเวลา',
	after_time:  'เริ่มหลังเส้นเวลา',
