...
window.calendar_languages['sr-cyrl-RS'] = {
	error_noview: 'Календар: Приказ {0} није пронађен',
	error_dateformat: 'Календар: Погрешан формат датума {0}. Треба да буде „сад” или „гггг-мм-дд”',
	error_loadurl: 'Календар: URL адреса догађаја није подешена',
	error_where: 'Календар: Погрешан смер навигације {0}. Може да буде само „следеће”, „претходно” или „данас”',
	error_timedevide: 'Календар: Параметар за поделу времена треба да дели 60 без децимала. На пример: 10, 15, 30',

	no_events_in_day: 'Нема догађаја у овом дану.',
	...
	time:        'Време',
	events:      'Догађаји',
	before_time: 'Завршава се пре временске осе',
	after_time:  'Почиње после временске осе',
