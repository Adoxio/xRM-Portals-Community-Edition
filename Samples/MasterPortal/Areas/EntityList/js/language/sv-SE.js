...
window.calendar_languages['sv-SE'] = {
	error_noview: 'Kalendervyn {0} hittades inte',
	error_dateformat: 'Kalendern har fel datumformat {0}. Måste vara antingen i dag eller åååå-mm-dd.',
	error_loadurl: 'Kalenderns händelse-URL är inte inställd',
	error_where: 'Kalendern har fel navigeringsriktning {0}. Kan endast vara \"nästa\", \"föregående\" eller \"idag\"',
	error_timedevide: 'Kalenderns parameter för tidsdelning ska dela 60 utan decimaler. Till exempel 10, 15, 30',

	no_events_in_day: 'Det finns inga händelser denna dag.',
	...
	time:        'Tid',
	events:      'Händelser',
	before_time: 'Slutar före tidslinjen',
	after_time:  'Startar efter tidslinje',
