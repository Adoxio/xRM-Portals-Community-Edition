...
window.calendar_languages['vi-VN'] = {
	error_noview: 'Lịch: Không tìm thấy dạng xem {0}',
	error_dateformat: 'Lịch: Sai định dạng ngày {0}. Phải là \"bây giờ\" hoặc \"dd-mm-yyyy\"',
	error_loadurl: 'Lịch: Không đặt URL sự kiện',
	error_where: 'Lịch: Sai hướng điều hướng {0}. Chỉ có thể là \"tiếp\" hoặc \"trước\" hoặc \"hôm nay\"',
	error_timedevide: 'Lịch: Tham số tách thời gian phải chia cho 60 mà không có số thập phân. Ví dụ: 10, 15, 30',

	no_events_in_day: 'Không có sự kiện nào trong ngày này.',
	...
	time:        'Thời gian',
	events:      'Sự kiện',
	before_time: 'Kết thúc trước dòng thời gian',
	after_time:  'Bắt đầu sau dòng thời gian',
