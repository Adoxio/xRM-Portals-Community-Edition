...
window.calendar_languages['pt-BR'] = {
	error_noview: 'Calendário: Exibição {0} não encontrada',
	error_dateformat: 'Calendário: Formato de data incorreto {0}. Deveria ser \"agora\" ou \"aaaa-mm-dd\"',
	error_loadurl: 'Calendário: A URL do evento não foi definida',
	error_where: 'Calendário: Direção de navegação incorreta {0}. Só pode ser \"próximo\" ou \"anterior\" ou \"hoje\"',
	error_timedevide: 'Calendário: O parâmetro de divisão de tempo deve consistir na divisão por 60 sem decimais. Por exemplo, algo como 10, 15, 30',

	no_events_in_day: 'Não há eventos neste dia.',
	...
	time:        'Hora',
	events:      'Eventos',
	before_time: 'Termina antes da linha de tempo',
	after_time:  'Começa depois da linha de tempo',
