...
window.calendar_languages['eu-ES'] = {
	error_noview: 'Egutegia: ez da aurkitu {0} ikuspegia',
	error_dateformat: 'Egutegia: {0} data-formatua ez da zuzena. \"orain\" edo \"uuuu-hh-ee\" formatua eduki behar du.',
	error_loadurl: 'Egutegia: ez da ezarri gertaeren URLa',
	error_where: 'Egutegia: {0} nabigazio-noranzkoa ez da zuzena. \"Hurrengoa\" edo \"aurrekoa\" soilik izan daiteke',
	error_timedevide: 'Egutegia: denbora zatitzeko parametroak 60 digitua zatitu behar du hamartarrik erabili gabe; adibidez, 10, 15 edo 30',

	no_events_in_day: 'Ez dago gertaerarik egun honetan.',
	...
	title_day: '{0}, {3}(e)ko {2}ren {1}a',

	week:'{0}. astea',
	all_day:     'Egun osoa',
	time:        'Ordua',
	events:      'Gertaerak',
	before_time: 'Denbora-eskala baino lehen amaitzen da',
	after_time:  'Denbora-eskala amaitu ostean hasiko da',
