...
window.calendar_languages['et-EE'] = {
	error_noview: 'Kalender: vaadet {0} ei leita',
	error_dateformat: 'Kalender: vale kuupäevavorming {0}. Peab olema kas vormingus \„praegu\” või pp-kk-aaaa.',
	error_loadurl: 'Kalender: sündmuse URL-i pole määratud',
	error_where: 'Kalender: vale navigeerimissuund {0}. Saab olla ainult \„järgmine\”, \„eelmine\” või \„täna\”',
	error_timedevide: 'Kalender: aja jagamise parameeter peaks 60 jagama ilma kümnendkohtadeta. Näiteks 10, 15, 30',

	no_events_in_day: 'Sel päeval pole sündmusi.',
	...
	time:        'Kellaaeg',
	events:      'Sündmused',
	before_time: 'Lõpeb enne ajaskaalat',
	after_time:  'Käivitub pärast ajaskaalat',
