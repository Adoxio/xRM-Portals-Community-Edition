...
window.calendar_languages['sr-latn-RS'] = {
	error_noview: 'Kalendar: Prikaz {0} nije pronađen',
	error_dateformat: 'Kalendar: Pogrešan format datuma {0}. Treba da bude „sad” ili „gggg-mm-dd”',
	error_loadurl: 'Kalendar: URL adresa događaja nije podešena',
	error_where: 'Kalendar: Pogrešan smer navigacije {0}. Može da bude samo „sledeće”, „prethodno” ili „danas”',
	error_timedevide: 'Kalendar: Parametar za podelu vremena treba da deli 60 bez decimala. Na primer: 10, 15, 30',

	no_events_in_day: 'Nema događaja u ovom danu.',
	...
	time:        'Vreme',
	events:      'Događaji',
	before_time: 'Završava se pre vremenske ose',
	after_time:  'Počinje posle vremenske ose',
