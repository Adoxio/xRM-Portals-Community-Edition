...
window.calendar_languages['gl-ES'] = {
	error_noview: 'Calendario: non se atopou a visualización {0}',
	error_dateformat: 'Calendario: formato de data incorrecto {0}. Debe ser \"agora\" ou presentar o formato \"dd-mm-aaaa\"',
	error_loadurl: 'Calendario: non se definiu o URL do evento',
	error_where: 'Calendario: enderezo de navegación incorrecto {0}. Só pode ser \"seguinte\", \"anterior\" ou \"hoxe\"',
	error_timedevide: 'Calendario: o parámetro de división de tempo debería dividir 60 sen decimais. Algo como 10, 15, 30',

	no_events_in_day: 'Non hai eventos neste día.',
	...
	time:        'Hora',
	events:      'Eventos',
	before_time: 'Finaliza antes da liña de tempo',
	after_time:  'Comeza despois da liña de tempo',
