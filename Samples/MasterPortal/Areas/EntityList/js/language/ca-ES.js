...
window.calendar_languages['ca-ES'] = {
	error_noview: 'Calendari: la visualització {0} no s\'ha trobat',
	error_dateformat: 'Calendari: format de data {0} incorrecte. Ha de ser \"ara\" o \"aaaa-mm-dd\"',
	error_loadurl: 'Calendari: l\'adreça URL d\'incidències no està definida',
	error_where: 'Calendari: direcció de navegació {0} incorrecta. Només pot ser \"següent\" o \"anterior\" o \"avui\"',
	error_timedevide: 'Calendari: el paràmetre de temps parcial ha de dividir 60 sense decimals. Per exemple, 10, 15, 30',

	no_events_in_day: 'No hi ha cap incidència aquest dia.',
	...
	time:        'Hora',
	events:      'Incidències',
	before_time: 'Acaba abans de l\'escala de temps',
	after_time:  'Comença després de l\'escala de temps',
