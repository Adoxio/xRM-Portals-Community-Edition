				...
				<% if (RequiresRegistration) { %>
					...
					<% if (CanRegister) { %>
						...
						<% } else { %>
							...
							<% } else { %>
								<adx:Snippet SnippetName="Event Registered Text" CssClass="alert alert-info" DefaultText="<%$ ResourceManager:You_Registered_For_This_Event_Message %>" EditType="Html" runat="server"/>
							<% } %>
						<% } %>
					<% } else { %>
							<a class="btn btn-block btn-lg btn-default" href="<%: Url.SignInUrl() %>" title="<%: Html.SnippetLiteral("Event Sign In to Register Button Text", ResourceManager.GetString("Sign_In_To_Register_For_This_Event")) %>">
								<span class="fa fa-sign-in" aria-hidden="true"></span>
								<%: Html.SnippetLiteral("Event Sign In to Register Button Text", ResourceManager.GetString("Sign_In_To_Register_For_This_Event")) %>
							</a>
					<% } %>
					</div>
				<% } %>
