...
<asp:Content runat="server" ContentPlaceHolderID="Title"><%: Html.SnippetLiteral("Issue Search Title", ResourceManager.GetString("Search_Issues_Defaulttext")) %></asp:Content>
<asp:Content ContentPlaceHolderID="PageHeader" runat="server">
	<ul class="breadcrumb">
		<% Html.RenderPartial("SiteMapPath"); %>
		<li class="active"><%: Html.SnippetLiteral("Issue Search Title", ResourceManager.GetString("Search_Issues_Defaulttext")) %></li>
	</ul>
</asp:Content>
