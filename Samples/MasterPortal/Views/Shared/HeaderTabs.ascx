					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<% if (Html.BooleanSetting("Header/ShowAllProfileNavigationLinks").GetValueOrDefault(true)) { %>
								...
								<% } %>
							<% } else { %>
								<li><a href="<%: Html.SiteMarkerUrl("Profile") %>" title="<%: Html.SnippetLiteral("Profile Link Text", ResourceManager.GetString("Profile")) %>"><%: Html.SnippetLiteral("Profile Link Text", ResourceManager.GetString("Profile")) %></a></li>
							<% } %>
