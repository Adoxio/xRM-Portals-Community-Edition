...
namespace Adxstudio.Xrm.Issues
{
	internal static class XContainerExtensions
	{
		...
		public static void AddFetchXmlLinkEntity(this XContainer entity, string linkEntityLogicalName, string linkFromAttributeLogicalName, string linkToAttributeLogicalName, Action<Action<string, string, string>> addFilterConditions, Action<Action<string, string, string, Action<Action<string, string, string>>>> addNestedLinkEntities = null)
		{
		...
		public static void AddFetchXmlLinkEntity(this XContainer entity, string linkEntityLogicalName, string linkFromAttributeLogicalName, string linkToAttributeLogicalName, Action<Action<string, string, string>> addFilterConditions)
		{
			entity.ThrowOnNull("entity");
