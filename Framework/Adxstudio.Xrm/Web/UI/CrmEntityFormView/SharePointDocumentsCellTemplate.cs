...
namespace Adxstudio.Xrm.Web.UI.CrmEntityFormView
{
	...
	/// </summary>
	public abstract class SharePointDocumentsCellTemplate : ICellTemplate
	{
		protected SharePointDocumentsCellTemplate(FormXmlCellMetadata metadata)
		{
		...
		{
			get { return "sharepoint-documents table table-striped"; }
		}
