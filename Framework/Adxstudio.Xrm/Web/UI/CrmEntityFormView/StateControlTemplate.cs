...
{
	public class StateControlTemplate : CellTemplate, ICustomFieldControlTemplate
	{
		public StateControlTemplate(CrmEntityFormViewField field, FormXmlCellMetadata metadata, string validationGroup, IDictionary<string, CellBinding> bindings)
		...
		protected override void InstantiateControlIn(Control container)
		{
			...
			var options = Metadata.StateOptionSetOptions;
