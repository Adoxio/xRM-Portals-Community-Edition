...
{
	public class CmsEntityFileAttachmentRouteHandler : IRouteHandler
	{
		public const string RoutePath = "_services/portal/{__portalScopeId__}/{entityLogicalName}/{id}/__files";

		public CmsEntityFileAttachmentRouteHandler(string portalName)
		{
		...
		public IHttpHandler GetHttpHandler(RequestContext requestContext)
		{
			...
			return new CmsEntityFileAttachmentHandler(PortalName, portalScopeId, entityLogicalName, id);
		}
