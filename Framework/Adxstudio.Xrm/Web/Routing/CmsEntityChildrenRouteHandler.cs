...
{
	public class CmsEntityChildrenRouteHandler : IRouteHandler
	{
		public const string RoutePath = "_services/portal/{__portalScopeId__}/{entityLogicalName}/{id}/__children";

		public CmsEntityChildrenRouteHandler(string portalName)
		{
		...
		public IHttpHandler GetHttpHandler(RequestContext requestContext)
		{
			...
			return new CmsEntityChildrenHandler(PortalName, portalScopeId, entityLogicalName, id);
		}
