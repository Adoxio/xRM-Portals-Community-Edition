...
{
	public class CmsEntityDeleteRouteHandler : IRouteHandler
	{
		public const string RoutePath = "_services/portal/{__portalScopeId__}/{entityLogicalName}/{id}/__delete";

		public CmsEntityDeleteRouteHandler(string portalName)
		{
		...
		public IHttpHandler GetHttpHandler(RequestContext requestContext)
		{
			...
			return new CmsEntityDeleteHandler(PortalName, portalScopeId, entityLogicalName, id);
		}
